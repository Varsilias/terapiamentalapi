...
export const createNewProduct = async (req: IRequest, res: Response) => {
  try {
    ...
    logger.error(
      `[TerapiaMentalException] - [ExceptionHandler] - [store.controller.createNewProduct]: ${error?.message}`,
    );
    return res
...
export const getAllProducts = async (req: IRequest, res: Response) => {
  try {
    ...
    logger.error(
      `[TerapiaMentalException] - [ExceptionHandler] - [store.controller.getAllProducts]: ${error?.message}`,
    );
    return res
      .status(HttpStatus.INTERNAL_SERVER_ERROR)
      .json({ status: false, message: "Unable to resolve request at this time" });
...
export const getAProduct = async (req: IRequest, res: Response) => {
  try {
    ...
    logger.error(
      `[TerapiaMentalException] - [ExceptionHandler] - [store.controller.getAProduct]: ${error?.message}`,
    );
    return res
      .status(HttpStatus.INTERNAL_SERVER_ERROR)
      .json({ status: false, message: "Unable to resolve request at this time" });
...
export const updateAProduct = async (req: IRequest, res: Response) => {
  try {
    ...
    logger.error(
      `[TerapiaMentalException] - [ExceptionHandler] - [store.controller.updateAProduct]: ${error?.message}`,
    );
    return res
      .status(HttpStatus.INTERNAL_SERVER_ERROR)
      .json({ status: false, message: "Unable to resolve request at this time" });
...
export const deleteAProduct = async (req: IRequest, res: Response) => {
  try {
    ...
    logger.error(
      `[TerapiaMentalException] - [ExceptionHandler] - [store.controller.deleteAProduct]: ${error?.message}`,
    );
    return res
      .status(HttpStatus.INTERNAL_SERVER_ERROR)
      .json({ status: false, message: "Unable to resolve request at this time" });
